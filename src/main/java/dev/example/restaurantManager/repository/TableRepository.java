...
public interface TableRepository extends JpaRepository<TableRest, String> {

    // 0. Count tables by name
    int countByName(String name);
    // 1. Find tables by name
    ArrayList<TableRest> findByName(String name);
    ...
    TableRest findByNameContaining(String letter);
    ...
    List<TableRest> findByNameContainingIgnoreCase(String namePart);
