...
//                System.out.println("--------------------");
        ...
        public void TestCreateOrderMenu () {
                ...
                MenuRestaurant menuRestaurant1 = new MenuRestaurant("Burger Menu", 10.99, "Burger, fries, and drink", true, true);
                // Save sample menus
                menuRestaurantRepository.save(menuRestaurant1);

                // Create Order object and assign menus
                OrderRestaurant orderRestaurant1 = new OrderRestaurant(new Date(), "John", 4, 43.96, true);

                // Save sample order
                orderRestaurantRepository.save(orderRestaurant1);

                // Create MenuQt
                OrderMenuQty orderMenuQty1 = new OrderMenuQty(2, menuRestaurant1, orderRestaurant1);
                ...
                assertFalse(orderMenuQtyRepository.findAll().isEmpty(), "It must not be empty");

                assertEquals(1, orderMenuQtyRepository.findAll().size(), "Expected size is 1");
