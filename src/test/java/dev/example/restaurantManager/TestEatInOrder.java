...
@DataJpaTest
public class TestEatInOrder {

    @Autowired
    private EatInOrderRepository eatInRepository;
    @Autowired
    ...
    public void TestCreateEatIn(){
        ...
        TableRestaurant table4 = new TableRestaurant("T04", "Rectangular","Mesa grande y rectangular" ,10,false, new ArrayList<>());
